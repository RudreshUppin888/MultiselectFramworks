...
public struct YBTextPickerAppearanceManager{
    ...
    var itemFont : UIFont?
     ...
     public init(
         ...
         closeButtonFont : UIFont,
         
         doneButtonTitle : String,
         doneButtonColor : UIColor,
         doneButtonFont : UIFont,
         
         itemCheckedImage : UIImage,
...
public class YBTextPicker: UIViewController {
    ...
    public var animation = YBTextPickerAnimation.FromBottom
   public var appearanceManager : YBTextPickerAppearanceManager?
